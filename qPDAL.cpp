...
qPDAL::qPDAL( QObject *parent )
	: QObject( parent )
	, ccStdPluginInterface( ":/CC/plugin/qPDAL/info.json" )
	, m_action( nullptr )
{
}
...
{	
	...
	m_app->dispToConsole( "[qPDAL] Hello world!", ccMainAppInterface::STD_CONSOLE_MESSAGE );
	
	// Display a warning message in the console
	m_app->dispToConsole( "[qPDAL] Warning: example plugin shouldn't be used as is", ccMainAppInterface::WRN_CONSOLE_MESSAGE );
